...
PaymentProtocol.LEGACY_PAYMENT.SEND.REQUEST_CONTENT_TYPE = 'application/socialsend-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.SEND.CONTENT_TYPE = 'application/socialsend-payment';
PaymentProtocol.LEGACY_PAYMENT.SEND.ACK_CONTENT_TYPE = 'application/socialsend-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'SEND';
  this.setObj(obj);
  return this;
};
